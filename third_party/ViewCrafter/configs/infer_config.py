...
def get_parser():
    ...
    ## dust3r
    parser.add_argument('--dust3r_path', type=str, default='./checkpoints/DUSt3R_ViTLarge_BaseDecoder_512_dpt.pth', help='The path of the model')
    ...
    parser.add_argument("--known_c2w", action='store_true', help="given c2w")
    parser.add_argument("--known_focal", action='store_true', help="given focal")
